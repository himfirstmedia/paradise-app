              ...
              >
                <View style={{ flexDirection: "row", gap: 10 }}>
                  <Image
                    ...
                    style={styles.icon}
                  />
                  <ThemedText type="default">Comments / Suggestions</ThemedText>
                </View>
                <Image
                  source={require("../../assets/icons/chevron-right.png")}
                  style={styles.icon}
              ...
              >
                <View style={{ flexDirection: "row", gap: 10 }}>
                  <Image
                    ...
                    style={styles.icon}
                  />
                  <ThemedText type="default">Manage Residents</ThemedText>
                </View>
                <Image
                  source={require("../../assets/icons/chevron-right.png")}
                  style={styles.icon}
              ...
              >
                <View style={{ flexDirection: "row", gap: 10 }}>
                  <Image
                    ...
                    style={styles.icon}
                  />
                  <ThemedText type="default">Manage Individuals</ThemedText>
                </View>
                <Image
                  source={require("../../assets/icons/chevron-right.png")}
                  style={styles.icon}
              ...
              >
                <View style={{ flexDirection: "row", gap: 10 }}>
                  <Image
                    ...
                    style={styles.icon}
                  />
                  <ThemedText type="default">Manage Tasks</ThemedText>
                </View>
                <Image
                  source={require("../../assets/icons/chevron-right.png")}
                  style={styles.icon}
